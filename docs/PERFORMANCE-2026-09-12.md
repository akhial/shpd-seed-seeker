...
| C20B closed duplicate-slot capacity | Target six-wand searches improved on native/Mac, but Linux cheap/eight-worker −1.29% and early/eight-worker −2.32%, all four negative, remain unresolved. Broader performance/latency/WASM acceptance is incomplete. Preserved separately; excluded from this checkpoint. |
...
| Unfinished C20B | Commit `2938075b4e04d969880d9c40b1e043fd320ef074`; frozen `candidates/c20b/`; observer/larger-world/control audits. Recorded measurements compare C18b+B against C18b; the preserved source commit contains C19d+B and has not been benchmarked as that combination. |
...
Resume by reading the ledger and artifact receipts, verifying source/binary hashes, and choosing the next evidence-backed cycle. Do not silently treat unfinished B/A/C21 or PGO as accepted, and do not replay old build scripts against a changed worktree without reviewing their preconditions.
