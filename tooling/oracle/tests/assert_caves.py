#!/usr/bin/env python3
"""Reduce full official-oracle documents to stable Caves parity fixtures."""
...
FIXTURE_SCHEMA = "shpd-caves-parity-fixture/v1"
...
def main():
    if len(sys.argv) < 3:
        raise SystemExit(
            "usage: assert_caves.py EXPECTED SEED=ORACLE_JSON...\n"
            "       assert_caves.py --print SEED=ORACLE_JSON..."
        )
