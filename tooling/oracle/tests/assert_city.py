#!/usr/bin/env python3
"""Reduce full official-oracle documents to stable City parity fixtures."""
...
def main():
    if len(sys.argv) < 3:
        raise SystemExit(
            "usage: assert_city.py EXPECTED SEED=ORACLE_JSON...\n"
            "       assert_city.py --print SEED=ORACLE_JSON..."
        )
