...
class AutoTrinketTest {
    ...
    @Test fun requiredStartingTrinketRetainsABeneficialAutomaticRecipe() {
        ...
        assertEquals("parchment_scrap", engine.filterRecipes(unselected, base, recipes).single().selectedTrinket)
