...
object DeepLink {
    ...
    fun encodeLink(query: PresetQuery): String {
        require((query.floorRequirements.isNotEmpty() || query.requirements.isNotEmpty() || query.arcaneResinAuto || query.arcaneResin > 0)) { "Add at least one requirement to share a search." }
