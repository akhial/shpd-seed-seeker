...
//! AAA-AAA-AAF Cracked Spyglass case rechecked against final v4.0.0.
...
//! The v4.0.0 journal defaults retain the floor-24 Halls lore page, changing the
...
fn selected_trinket_loot_matches_java_fixtures() {
    let cases: Vec<Case> =
        serde_json::from_str(include_str!("fixtures/selected_trinkets_v4.0.0.json")).unwrap();
