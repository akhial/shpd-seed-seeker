...
// request SSF2, results SSR1, scout SSC1 (documented in the Kotlin adapter).
...
int32_t seedfinder_status(int64_t handle, int64_t out_status[4]); // [state, scanned, total, errorCode]
