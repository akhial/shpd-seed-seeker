...
Interactive searches print `Seed Seeker v<version>` once at startup, before the
optional starting seed and `Searching for N requirements...`, using the CLI's release version.
