...
import init, { filter_seeds, scout, SearchSession } from "../../engine/pkg/seedfinder.js";
import type { SearchAdvance } from "../../engine/types";
...
const ready = init(new URL("../../engine/pkg/seedfinder_bg.wasm", import.meta.url));
